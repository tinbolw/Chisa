...
module.exports = {
  guild: async function () {
    // Get guild commands
    return axios.get(`https://discord.com/api/v8/applications/${process.env.CLIENT_ID}/guilds/${process.env.GUILD_ID}/commands`, {
      headers: {
  ...
  global: async function () {
    // Get global commands
    return axios.get(`https://discord.com/api/v8/applications/${process.env.CLIENT_ID}/commands`, {
      headers: {
        "Authorization": "Bot " + process.env.TOKEN
      }
    })
